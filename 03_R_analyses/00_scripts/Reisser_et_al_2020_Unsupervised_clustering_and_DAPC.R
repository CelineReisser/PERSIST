...
fst.ci <- fst_WC84(data = dat, 
                   pop.levels = c("C1","C2","C3", "C4", "C5", "E1", "E2", "E3", "E4", "E5", "E6", "N2", "N3", "N4", "N5", "N6", "N7"),
                   pairwise = TRUE,
                   ci = TRUE,
                   iteration.ci=5000,
...
heatmap_fst(fst.matrix, fst.ci.matrix, n.s = TRUE,
            ...
            pop.levels = c("C1","C2","C3", "C4", "C5", "E1", "E2", "E3", "E4", "E5", "E6", "N2", "N3", "N4", "N5", "N6", "N7"), path.folder = NULL, filename = NULL)
